                    ...
                    <div className='flex items-center justify-center'>
                      <div
                        className={`h-2.5 w-2.5 rounded-full mr-2 ${
                          ticket.estatus === 1 ? 'bg-green-500' : 'bg-red-500'
                        }`}
                      ></div>
                      {ticket.estatus === 1 ? 'Abierto' : 'Cerrado'}
                    </div>
                  </td>
                  <td className='px-6 py-4 flex justify-center space-x-3'>
                    <button className='text-blue-600 dark:text-blue-500 hover:scale-110 transition-transform p-1 cursor-pointer'>
                      <svg
                        className='w-5 h-5'
                        fill='none'
                        stroke='currentColor'
